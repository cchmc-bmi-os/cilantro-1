...
define([
    ...
    var FieldModel = base.Model.extend({
        ...
        distribution: function(handler, cache) {
            ...
            // This edit is to facilitate context-aware data charts.
            // We're turning off the data cache so that the client
            // obtains new data each time the chart is rendered, capturing
            // any context changes.
            if (false){//(cache && (this._cache.distribution !== undefined)) {
